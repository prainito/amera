...
interface GrowthVaultProps {
  onDeposit: () => void
  onWithdraw: () => void
}

export default function GrowthVault({ onDeposit, onWithdraw }: GrowthVaultProps) {
  const { connected } = useWallet()

  // Mock data for the vault
  const vaultData = {
    name: "Amera Growth Vault",
    description: "Balanced strategy designed for steady growth with moderate volatility",
    apy: 10.2,
    tvl: 8500000, // $8.5M
    userDeposit: 750, // $750
    capacity: 20000000, // $20M
    utilizationRate: 42.5, // 42.5%
    lockPeriod: "None",
    riskLevel: "Medium",
    riskColor: "yellow",
  }
      ...
      <CardContent className="pb-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center text-sm">
            ...
            <span>Enhanced yield through optimized lending strategies with established protocols</span>
          </div>
        </div>
      </CardContent>
