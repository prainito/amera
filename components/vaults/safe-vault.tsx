...
export default function SafeVault({ onDeposit, onWithdraw }: SafeVaultProps) {
  const { connected } = useWallet()

  // Mock data for the vault
  const vaultData = {
    name: "Amera Safe Vault",
    description: "Our most conservative strategy focused on capital preservation with steady returns",
    apy: 5.2,
    tvl: 15000000, // $15M
    userDeposit: 1000, // $1000
    capacity: 25000000, // $25M
    utilizationRate: 60, // 60%
    lockPeriod: "None",
    riskLevel: "Low",
    riskColor: "green",
  }
      ...
      <CardContent className="pb-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center text-sm">
            ...
            <span>Institutional-grade security with diversified lending to blue-chip partners</span>
          </div>
        </div>
      </CardContent>
